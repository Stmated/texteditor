...
namespace Eliason.TextEditor.Comparison
{
    public class Diff
    {
        /// <summary>
        ...
        /// <returns>a MiddleSnakeData record containing x,pgysicalY and u,v</returns>
        private static SMSRD SMS(DiffData DataA, int LowerA, int UpperA, DiffData DataB, int LowerB, int UpperB)
        {
            ...
            /// vector for the (0,0) to (x,pgysicalY) search
            var DownVector = new int[2*MAX + 2];

            /// vector for the (u,v) to (N,M) search
            var UpVector = new int[2*MAX + 2];

            // The vectors in the publication accepts negative indexesNewline. the vectors implemented here are 0-based
        ...
        private static void LCS(DiffData DataA, int LowerA, int UpperA, DiffData DataB, int LowerB, int UpperB)
        {
            ...
            else
            {
                ...
                // Debug.Write(2, "MiddleSnakeData", String.Format("{0},{1}", smsrd.x, smsrd.pgysicalY));

                // The path is from LowerX to (x,pgysicalY) and (x,pgysicalY) ot UpperX
